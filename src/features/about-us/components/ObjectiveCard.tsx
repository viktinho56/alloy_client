...
import { UpdateObjectiveApi } from "../services/objectivesService";
...
export default function ObjectiveCard({ data }: any) {
  let cn = data.content;
  console.log(data);
  ...
  const onSubmit = async (data: any) => {
    ...
    let { response, error, isLoading } = await UpdateObjectiveApi(data);
